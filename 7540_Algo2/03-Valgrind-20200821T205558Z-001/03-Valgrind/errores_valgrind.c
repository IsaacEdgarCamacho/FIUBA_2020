...
/* 
Compilacion:
    gcc -g errores_valgrind.c -o errores
...
void pisar_memoria(){
    ...
    // Solución: Liberar un malloc antes de redefinirlo
    free(arreglo);
...
int main() {
    ...
    no_inicializar_estatico();
    no_inicializar_dinamico();
    escritura_error();
    lectura_error();
